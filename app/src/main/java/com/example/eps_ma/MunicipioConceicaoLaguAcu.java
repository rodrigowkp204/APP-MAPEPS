...
public class MunicipioConceicaoLaguAcu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_municipio_conceicao_lagu_acu);
        ...
        bt_voltar_municipio_conceicao_lagu_acu = findViewById(R.id.bt_voltar_municipio_conceicao_lagu_acu);
        bt_voltar_municipio_conceicao_lagu_acu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent voltar_regioes_saude = new Intent(MunicipioConceicaoLaguAcu.this, Bacabal.class);
    ...
    private void obterDadosDoFirestore() {
        ...
        String nomeDocumento = "tec_acs_conceicao_lagu_acu"; // Substitua pelo nome do seu documento
    ...
    private void IniciarComponentes(){
        recyclerView = findViewById(R.id.info_cursos_conceicao_lagu_acu);
    }
}