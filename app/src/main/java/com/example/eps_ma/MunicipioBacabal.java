...
public class MunicipioBacabal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_municipio_bacabal);
        ...
        bt_voltar_municipio_bacabal = findViewById(R.id.bt_voltar_municipio_bacabal);
        bt_voltar_municipio_bacabal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent voltar_regioes_saude = new Intent(MunicipioBacabal.this, Bacabal.class);
    ...
    private void obterDadosDoFirestore() {
        ...
        String nomeDocumento = "tec_enfermagem_bacabal"; // Substitua pelo nome do seu documento
    ...
    private void IniciarComponentes(){
        recyclerView = findViewById(R.id.info_cursos_bacabal);
    }
}